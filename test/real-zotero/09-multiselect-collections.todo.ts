 ...
 * Numbered below 90 because it leaves Citegeist running (00-root-hooks.spec.ts).
 *
 ...
 *    request log, reading only entries added after the command starts).
 ...
 *    error (the root afterEach fails any new `[Citegeist] ERROR` line).
 */
export {};
